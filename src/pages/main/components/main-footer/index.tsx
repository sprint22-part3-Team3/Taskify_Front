...
function MainFooter() {
  return (
    <footer className="bg-black-200">
      <div className="mx-auto flex h-58 w-full max-w-440 flex-col items-center justify-center gap-10 px-6 text-center md:h-25 md:flex-row md:justify-between md:gap-0 md:px-8 md:text-left">
