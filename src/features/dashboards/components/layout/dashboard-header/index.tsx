import type { HeaderProps } from '@/features/dashboards/components/layout/dashboard-header/dashboardHeader.types';
...
export default function Header({
  ...
  return (
    <header className="lg:justify-betweenn z-header flex h-15 min-w-0 items-center justify-between border-b border-gray-200 bg-white pl-4 md:h-17.5 md:px-10">
      {/* 제목 - 데스크탑에서만 표시 */}
