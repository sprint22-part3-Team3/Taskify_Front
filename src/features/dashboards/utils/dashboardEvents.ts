...
const MEMBER_LIST_CHANGE_EVENT = 'member-list-change';
...
export const DASHBOARD_EVENTS = {
  ...
  MEMBER_LIST_CHANGE: MEMBER_LIST_CHANGE_EVENT,
} as const;
...
/**
 * 구성원 목록 갱신이 필요할 때 이벤트를 발행합니다.
 */
export const dispatchMemberListChangeEvent = () => {
  window.dispatchEvent(new Event(MEMBER_LIST_CHANGE_EVENT));
};
